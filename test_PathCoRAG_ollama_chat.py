"""
PathCoRAG Ollama Compatibility Interface Test Script

This script tests the PathCoRAG's Ollama compatibility interface, including:
...
def create_error_test_data(error_type: str) -> Dict[str, Any]:
    ...
    """
    error_data = {
        "empty_messages": {"model": "PathCoRAG:latest", "messages": [], "stream": True},
        "invalid_role": {
            "model": "PathCoRAG:latest",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="PathCoRAG Ollama Compatibility Interface Testing",
...
Configuration file (config.json):
  {
    "server": {
      ...
      "model": "PathCoRAG:latest" # Default model name
    },
    "test_cases": {
      "basic": {
