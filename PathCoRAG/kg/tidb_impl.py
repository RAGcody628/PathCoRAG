...
TABLES = {
    "PathCoRAG_DOC_FULL": {
        "ddl": """
        CREATE TABLE PathCoRAG_DOC_FULL (
    ...
    "PathCoRAG_DOC_CHUNKS": {
        "ddl": """
        CREATE TABLE PathCoRAG_DOC_CHUNKS (
            `id` BIGINT PRIMARY KEY AUTO_RANDOM,
    ...
    "PathCoRAG_GRAPH_NODES": {
        "ddl": """
        CREATE TABLE PathCoRAG_GRAPH_NODES (
            `id` BIGINT PRIMARY KEY AUTO_RANDOM,
    ...
    "PathCoRAG_GRAPH_EDGES": {
        "ddl": """
        CREATE TABLE PathCoRAG_GRAPH_EDGES (
            `id` BIGINT PRIMARY KEY AUTO_RANDOM,
    ...
    "PathCoRAG_LLM_CACHE": {
        "ddl": """
        CREATE TABLE PathCoRAG_LLM_CACHE (
...
SQL_TEMPLATES = {
    # SQL for KVStorage
    "get_by_id_full_docs": "SELECT doc_id as id, IFNULL(content, '') AS content FROM PathCoRAG_DOC_FULL WHERE doc_id = :id AND workspace = :workspace",
    "get_by_id_text_chunks": "SELECT chunk_id as id, tokens, IFNULL(content, '') AS content, chunk_order_index, full_doc_id FROM PathCoRAG_DOC_CHUNKS WHERE chunk_id = :id AND workspace = :workspace",
    "get_by_ids_full_docs": "SELECT doc_id as id, IFNULL(content, '') AS content FROM PathCoRAG_DOC_FULL WHERE doc_id IN ({ids}) AND workspace = :workspace",
    "get_by_ids_text_chunks": "SELECT chunk_id as id, tokens, IFNULL(content, '') AS content, chunk_order_index, full_doc_id FROM PathCoRAG_DOC_CHUNKS WHERE chunk_id IN ({ids}) AND workspace = :workspace",
    ...
    "upsert_doc_full": """
        INSERT INTO PathCoRAG_DOC_FULL (doc_id, content, workspace)
    ...
    """,
    "upsert_chunk": """
        INSERT INTO PathCoRAG_DOC_CHUNKS(chunk_id, content, tokens, chunk_order_index, full_doc_id, content_vector, workspace)
    ...
    "entities": """SELECT n.name as entity_name FROM
        ...
        FROM PathCoRAG_GRAPH_NODES WHERE workspace = :workspace) n
    ...
    "relationships": """SELECT e.source_name as src_id, e.target_name as tgt_id FROM
        ...
        FROM PathCoRAG_GRAPH_EDGES WHERE workspace = :workspace) e
    ...
    "chunks": """SELECT c.id FROM
        ...
        FROM PathCoRAG_DOC_CHUNKS WHERE workspace = :workspace) c
        WHERE c.distance>:better_than_threshold ORDER BY c.distance DESC LIMIT :top_k
    """,
    "has_entity": """
        SELECT COUNT(id) AS cnt FROM PathCoRAG_GRAPH_NODES WHERE name = :name AND workspace = :workspace
    """,
    "has_relationship": """
        SELECT COUNT(id) AS cnt FROM PathCoRAG_GRAPH_EDGES WHERE source_name = :source_name AND target_name = :target_name AND workspace = :workspace
    """,
    "update_entity": """
        UPDATE PathCoRAG_GRAPH_NODES SET
    ...
    """,
    "update_relationship": """
        UPDATE PathCoRAG_GRAPH_EDGES SET
    ...
    """,
    "insert_entity": """
        INSERT INTO PathCoRAG_GRAPH_NODES(entity_id, name, content, content_vector, workspace)
        VALUES(:id, :name, :content, :content_vector, :workspace)
    """,
    "insert_relationship": """
        INSERT INTO PathCoRAG_GRAPH_EDGES(relation_id, source_name, target_name, content, content_vector, workspace)
    ...
    "get_node": """
        ...
        FROM PathCoRAG_GRAPH_NODES WHERE name = :name AND workspace = :workspace
    """,
    "get_edge": """
        ...
        FROM PathCoRAG_GRAPH_EDGES WHERE source_name = :source_name AND target_name = :target_name AND workspace = :workspace
    """,
    "get_node_edges": """
        ...
        FROM PathCoRAG_GRAPH_EDGES WHERE source_name = :source_name AND workspace = :workspace
    """,
    "node_degree": """
        SELECT COUNT(id) AS cnt FROM PathCoRAG_GRAPH_EDGES WHERE workspace = :workspace AND :name IN (source_name, target_name)
    """,
    "upsert_node": """
        INSERT INTO PathCoRAG_GRAPH_NODES(name, content, content_vector, workspace, source_chunk_id, entity_type, description)
    ...
    """,
    "upsert_edge": """
        INSERT INTO PathCoRAG_GRAPH_EDGES(source_name, target_name, content, content_vector,
