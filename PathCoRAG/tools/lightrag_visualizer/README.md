# PathCoRAG 3D Graph Viewer

An interactive 3D graph visualization tool included in the PathCoRAG package for visualizing and analyzing RAG (Retrieval-Augmented Generation) graphs and other graph structures.
...
### Quick Install
```bash
pip install PathCoRAG-hku[tools]  # Install with visualization tool only
# or
pip install PathCoRAG-hku[api,tools]  # Install with both API and visualization tools
```
...
- GitHub Issues: [PathCoRAG Repository](https://github.com/HKUDS/PathCoRAG)
- Documentation: [PathCoRAG Docs](https://URL-to-docs)

## License

This tool is part of PathCoRAG and is distributed under the MIT License. See `LICENSE` for more information.

Note: This visualization tool is an optional component of the PathCoRAG package. Install with the [tools] option to access the viewer functionality.
